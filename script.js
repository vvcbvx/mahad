...
// في القائمة الجانبية أضف:
// <li><a href="#" onclick="showExams()"><i class="fas fa-file-pdf"></i> الامتحانات</a></li>

// وفي أيقونات الصفحة الرئيسية أضف:
/*
<div class="home-icon" onclick="showExams()">
    <div class="icon-circle">
        <i class="fas fa-file-pdf"></i>
    </div>
    <span class="icon-text">الامتحانات</span>
</div>
*/
...
function renderExams(filteredExams = null) {
    ...
    examsToRender.forEach(exam => {
        ...
        const filePath = `exams/${encodeURIComponent(exam.file)}`; // إضافة الترميز
        ...
        // إضافة معالجة الأخطاء للتحميل
        examCard.querySelector('.exam-download').addEventListener('click', async (e) => {
            e.preventDefault();
            try {
...
function setupFilterButtons() {
    ...
    document.querySelectorAll('.exams-filter .filter-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            // Show/hide subject filter based on selection
